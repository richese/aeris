...
CNeuralNetworkTest::CNeuralNetworkTest()
{
	...
	NeuralNetworkInitStructure_init(&nn_init_structure, 4, 1.0, 5, neuron_type, eta, gamma);
	...
	*/
	...
	nn_init_structure.init_vector[0] = inputs_count;
	nn_init_structure.init_vector[1] = 8;
	nn_init_structure.init_vector[2] = 8;
	nn_init_structure.init_vector[3] = outputs_count;
...
void CNeuralNetworkTest::set_required_output()
{
	...
	//required_output[0] = -input[0];
	//required_output[1] = -input[1];
}
