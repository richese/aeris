...
#define ROBOT_TYPE_RED_ROBOT 			((u32)8|ROBOT_MOVEABLE_FLAG)
#define ROBOT_TYPE_RED_TARGET			((u32)9)
#define ROBOT_TYPE_RED_PATH				((u32)10)

#define ROBOT_TYPE_GREEN_ROBOT 			((u32)11|ROBOT_MOVEABLE_FLAG)
#define ROBOT_TYPE_GREEN_TARGET			((u32)12)
#define ROBOT_TYPE_GREEN_PATH				((u32)13)

#define ROBOT_TYPE_BLUE_ROBOT 			((u32)14|ROBOT_MOVEABLE_FLAG)
