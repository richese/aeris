...
void CServer::add_new_robot(struct sRobot robot)
{
    u32 i;
   ...
   // robot.type = robot_type;
    ...
    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
    {
        ...
        if (robot.type&ROBOT_STRONG_SOLID_FLAG)
        {
            robot.force_max[i] = ROBOT_FORCE_MAX;
            robot.force[i] = ROBOT_FORCE_MAX;
        }
        else
        if (robot.type&ROBOT_MOVEABLE_FLAG)
        {
...
void CServer::update_sensors(u32 robot_idx)
{
    ...
    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
        robots[robot_idx].sensors[ROBOT_SENSOR_RED_POSITION_0_IDX + i] = 1.0;
    robots[robot_idx].sensors[ROBOT_SENSOR_RED_DISTANCE_IDX] = 1.0*ROBOT_SPACE_DIMENSION;

    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
        robots[robot_idx].sensors[ROBOT_SENSOR_GREEN_POSITION_0_IDX + i] = 1.0;
    robots[robot_idx].sensors[ROBOT_SENSOR_GREEN_DISTANCE_IDX] = 1.0*ROBOT_SPACE_DIMENSION;
    ...
    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
        robots[robot_idx].sensors[ROBOT_SENSOR_RED_PATH_POSITION_0_IDX + i] = 1.0;
    robots[robot_idx].sensors[ROBOT_SENSOR_RED_PATH_DISTANCE_IDX] = 1.0*ROBOT_SPACE_DIMENSION;

    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
        robots[robot_idx].sensors[ROBOT_SENSOR_GREEN_PATH_POSITION_0_IDX + i] = 1.0;
    robots[robot_idx].sensors[ROBOT_SENSOR_GREEN_PATH_DISTANCE_IDX] = 1.0*ROBOT_SPACE_DIMENSION;
    ...
    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
        robots[robot_idx].sensors[ROBOT_SENSOR_RED_PHEROMONE_POSITION_0_IDX + i] = 1.0;
    robots[robot_idx].sensors[ROBOT_SENSOR_RED_PHEROMONE_DISTANCE_IDX] = 1.0*ROBOT_SPACE_DIMENSION;

    for (i = 0; i < ROBOT_SPACE_DIMENSION; i++)
        robots[robot_idx].sensors[ROBOT_SENSOR_GREEN_PHEROMONE_POSITION_0_IDX + i] = 1.0;
    robots[robot_idx].sensors[ROBOT_SENSOR_GREEN_PHEROMONE_DISTANCE_IDX] = 1.0*ROBOT_SPACE_DIMENSION;
