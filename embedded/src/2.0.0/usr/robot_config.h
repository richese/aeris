...
#define CONFIG_USE_PREDICTOR         0      /*this enables line shape predictor to estimate base speed*/

#define   CONFIG_KP                 (float)0.326  /*proportional*/
#define   CONFIG_KI                 (float)0.0    /*integrate*/
#define   CONFIG_KD                 (float)10.53  /*derivative*/
...
#define   CONFIG_SPEED_BASE         (float)0.6    /*base robot speed - for mode without predictor*/
